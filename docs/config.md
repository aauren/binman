...
| maxapiqueries | number of concurrent api queries to allow. Defaults to maxdownloads. Useful if you have many repos and want a wide query fanout without widening downloads |
